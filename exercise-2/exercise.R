...
length <- paste("The difference in length is")
number <- 3
...
first <- paste("Your first string is longer by N characters")
second <- paste("Your second string is longer by N characters")
